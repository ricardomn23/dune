    ...
    namespace GoToPoint
    {
      ...
      struct Task: public DUNE::Tasks::Task
      {
          ...
          DUNE::Tasks::Task(name, ctx)
        {
          ...
          param("goal", m_args.goal)
          .defaultValue("10.0, 10.0, 10.0")
          .size(3)
          .description("Posição do objetivo");
        ...
        onUpdateParameters(void)
        {
          ...
          goal(0) = m_args.goal[0];
          goal(1) = m_args.goal[1];
          goal(2) = m_args.goal[2];
        }
        ...
        consume(const IMC::SimulatedState* msg)
        {
          ...
          Behaviour::Actuation act = b->goToPoint(goal, state, dstate);
          ...
          if( b->hasReachedPoint(state) ){
            ...
            if(!hasReachedPoint){
              ...
              std::cout <<"BUV has Reached Point!"<< std::endl;
